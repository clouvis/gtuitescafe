...
export class AutoSubmissionScreen {
    ...
    async bindIssueButton(value){
        ...
        if(await this.uWBlockProgressIssuesPopupIssuesScreen.isAvailable()){
            ...
            // let listViewLength = await customPages.submissionWizardJob_RiskAnalysisScreenRiskAnalysisCVRiskEvaluationPanelSet.rowCount();
            // for(let i=1; i<listViewLength  && await customPages.submissionWizardJob_RiskAnalysisScreenRiskAnalysisCVRiskEvaluationPanelSet.getTextFromCell(i,1) != "Informational"; i++){
